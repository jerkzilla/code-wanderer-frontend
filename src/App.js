    ...
    const wanders = [
      {
        ...
        name: "jsHolyGrail",
        link:
          "https://docs.google.com/document/d/13zS64bha7k0RT_zM2KgRLhDGMav01BIuJjdLMyHDfGA/edit",
      },
      {
        id: 2,
        name: "htmlDomEvents",
      ...
      {
        id: 5,
        name: "expressionsVsStatements",
        link: "https://2ality.com/2012/09/expressions-vs-statements.html",
      },
      {
        id: 6,
      ...
      },
      {
        id: 7,
        name: "destructuring",
        link: "https://scrimba.com/scrim/cnVZVHE?pl=p7v3gCd",
      },
      {
        id: 8,
        name: "jsProject",
        link:
          "https://medium.com/swlh/javascript-project-flatiron-school-bd7c1f3aebd7",
      },
      {
        id: 9,
        name: "deployingHeroku",
        link:
      ...
      { id: 13, name: "sharkle", link: "https://sharkle.com/" },
      {
        id: 14,
        name: "vizualizer",
        link: "http://iacopoapps.appspot.com/hopalongwebgl/",
      },
      {
        id: 15,
        name: "electricLines",
        link: "https://codepen.io/hexapode/full/XJPKWY/",
      },
      {
        id: 16,
        name: "dancingInstances",
        link: "https://guillaumegouessan.com/sketches/dancing-instances/",
      },
      {
        id: 17,
        name: "insideFiber",
      ...
      {
        id: 18,
        name: "understandingGit",
        link: "https://hackernoon.com/understanding-git-fcffd87c15a3",
      },
      { id: 19, name: "framerMotion", link: "https://www.framer.com/motion/" },
      {
        id: 20,
        name: "cSharpUnity",
        link: "https://unity3d.com/learning-c-sharp-in-unity-for-beginners",
      },
      ...
      },
      {
        ...
        link: "https://www.bestcssbuttongenerator.com/#/0",
      },
      { id: 29, name: "coolPortfolio", link: "https://khang-nd.github.io/" },
      {
        id: 30,
        name: "reactProjectBlog",
        link:
          "https://medium.com/@julianafogg/react-redux-portfolio-project-804ba6268ea0",
      },
      {
        id: 31,
      ...
      <div className="App">
        ...
        <Route
          ...
          render={(routerProps) => {
            ...
            const catObj = this.props.categories.find(
